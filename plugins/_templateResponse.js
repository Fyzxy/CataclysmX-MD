...
export async function all(m, chatUpdate) {
  ...
  if (m.message.buttonsResponseMessage) {
    ...
    const nativeFlowData = JSON.parse(m.message.interactiveResponseMessage.nativeFlowResponseMessage.paramsJson)
    id = nativeFlowData.id
  }
  ...
  let messages = await generateWAMessage(m.chat, { text: isIdMessage ? id : text, mentions: m.mentionedJid }, { userJid: this.user.id, quoted: m.quoted && m.quoted.fakeObj })
